...
WHERE
        (t."full_text" like '%kozel %' or t."full_text" like '%Kozel %' or t."hashtags" like '%kozel %') and t."full_text" not like '%magarci %' ; 
-- 3 
...
WHERE
        ...
        ((t."full_text" like '%pramen %' or t."full_text" like '%Pramen %')  and (t."full_text" like '%pivo %' or t."full_text" like '%beer %' ))); 
-- 14
...
FROM "twitter_redshift_db"."awstronauts_academy_final_test"."full_text_once_view" as t
WHERE
        (t."full_text" like '%heineken %' or t."full_text" like '%Heineken %' or t."hashtags" like '%heineken %' or 
...
WHERE
        ...
        and t."full_text" not like '%pravo%' and t."full_text" not like '%baranj%' and t."full_text" not like '%kult%' and t."full_text" not like '%kupali%'
...
WHERE
        ...
        and 
        (t."full_text" like '%beer%' or t."full_text" like '% pij%' or t."full_text" like '% pivo%') and t."full_text" not like '%kralj%';
-- 3